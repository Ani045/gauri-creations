    ...
    <header class="ec-nav-main" id="navbar">
        <div class="ec-nav-inner">
            ...
            <nav class="hidden md:flex items-center gap-8">
                ...
                <a href="/upcoming-classes" class="text-[15px] font-semibold <?= ($activePage ?? '') === 'upcoming' ? 'text-[#fc880d]' : 'text-dark hover:text-[#fc880d]' ?> transition-colors">Upcoming Classes</a>
    ...
    <nav class="ec-cat-bar" id="ec-cat-bar">
        <div class="ec-cat-inner">
            <a href="/courses" class="ec-cat-all"><i data-lucide="layout-grid" class="w-4 h-4"></i> All Categories</a>
            ...
            <a href="/courses" class="ec-cat-link">Workshops</a>
    ...
    <div class="ec-mobile-menu" id="ec-mobile-menu">
        <div class="ec-mobile-panel">
            ...
            <div class="ec-mobile-links">
                ...
                <a href="/upcoming-classes" class="ec-mobile-link" <?= ($activePage ?? '') === 'upcoming' ? 'style="background: #FFF3E0; color: #fc880d;"' : '' ?>><i data-lucide="calendar-clock" class="w-5 h-5"></i> Upcoming Classes</a>
    ...
    <script>
        // Simple hamburger menu logic for the navbar
        document.addEventListener('DOMContentLoaded', () => {
            const hamburger = document.getElementById('ec-hamburger');
            const closeBtn = document.getElementById('ec-mobile-close');
