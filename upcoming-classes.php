            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
                ...
                <div class="upcoming-card animate-fade-up" style="animation-delay:0.1s" id="course-sugar-craft">
                    <div class="flex flex-col md:flex-row">
                        <!-- Image -->
                        <div class="relative w-full md:w-[38%] h-[220px] md:h-auto overflow-hidden flex-shrink-0">
                            <img src="assets/images/sugar-craft-1.jpeg" alt="Sugar Craft Cake Decorating" class="w-full h-full object-cover hover:scale-105 transition-transform duration-700" style="min-height:100%">
                        ...
                        <!-- Content -->
                        <div class="flex-1 min-w-0 p-5 md:p-6 flex flex-col justify-between">
                            <div>
                                ...
                                <h3 class="font-bold text-dark text-base md:text-lg mb-2 leading-snug">Sugar Craft Cake Decorating</h3>
                                <p class="text-gray-400 text-[12px] leading-relaxed mb-3">Learn fondant dough from scratch, sugarpaste techniques, flower making, animal figures & professional cake covering.</p>

                                <!-- Details grid -->
                                <div class="grid grid-cols-2 gap-1.5 mb-3">
                                    <div class="flex items-center gap-1.5 text-[11px] text-gray-500 bg-[#FFF8F0] px-2.5 py-2 rounded-lg">
                                        <i data-lucide="calendar" class="w-3 h-3 text-mustard flex-shrink-0"></i>
                                        <span><strong class="text-dark">18 - 19 Apr</strong></span>
                                    </div>
                                    <div class="flex items-center gap-1.5 text-[11px] text-gray-500 bg-[#FFF8F0] px-2.5 py-2 rounded-lg">
                                        <i data-lucide="clock" class="w-3 h-3 text-mustard flex-shrink-0"></i>
                                        <span>11 AM – 5 PM</span>
                                    </div>
                                    <div class="flex items-center gap-1.5 text-[11px] text-gray-500 bg-[#FFF8F0] px-2.5 py-2 rounded-lg">
                                        <i data-lucide="map-pin" class="w-3 h-3 text-mustard flex-shrink-0"></i>
                                        <span>Gurgaon, Sec 38</span>
                                    </div>
                                    <div class="flex items-center gap-1.5 text-[11px] text-gray-500 bg-[#FFF8F0] px-2.5 py-2 rounded-lg">
                                        <i data-lucide="users" class="w-3 h-3 text-mustard flex-shrink-0"></i>
                            ...
                            <div class="flex flex-wrap items-center gap-3 pt-3 border-t border-gray-100">
                                ...
                                <a href="/courses/sugar-craft" class="ml-auto bg-mustard hover:bg-mustard-dark text-white font-semibold px-4 py-2 rounded-xl text-xs transition-all inline-flex items-center gap-1.5 shadow-[0_4px_16px_rgba(252,136,13,0.25)] hover:shadow-[0_6px_24px_rgba(252,136,13,0.35)] hover:-translate-y-0.5 whitespace-nowrap">
                                    Enroll Now <i data-lucide="arrow-right" class="w-3.5 h-3.5"></i>
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="upcoming-card animate-fade-up" style="animation-delay:0.2s" id="course-mexican">
                    <div class="flex flex-col md:flex-row">
                        <div class="relative w-full md:w-[38%] h-[220px] md:h-auto overflow-hidden flex-shrink-0">
                            <img src="assets/images/143.jpeg" alt="Authentic Mexican Cuisines" class="w-full h-full object-cover hover:scale-105 transition-transform duration-700" style="min-height:100%">
                            <div class="absolute inset-0 bg-gradient-to-t md:bg-gradient-to-r from-black/30 to-transparent pointer-events-none"></div>
                        ...
                        <div class="flex-1 min-w-0 p-5 md:p-6 flex flex-col justify-between">
                            <div>
                                ...
                                <h3 class="font-bold text-dark text-base md:text-lg mb-2 leading-snug">Authentic & Exotic Mexican Cuisines</h3>
                                <p class="text-gray-400 text-[12px] leading-relaxed mb-3">20 practicals, 35 recipes — Tacos, Enchiladas, Burritos, Nachos, Sauces & much more. Bold, authentic flavors!</p>
                                ...
                                <div class="grid grid-cols-2 gap-1.5 mb-3">
                                    ...
                                    <div class="flex items-center gap-1.5 text-[11px] text-gray-500 bg-[#FFF8F0] px-2.5 py-2 rounded-lg">
                                        <i data-lucide="utensils" class="w-3 h-3 text-mustard flex-shrink-0"></i>
                            ...
                            <div class="flex flex-wrap items-center gap-3 pt-3 border-t border-gray-100">
                                ...
                                <a href="/courses/mexican" class="ml-auto bg-mustard hover:bg-mustard-dark text-white font-semibold px-4 py-2 rounded-xl text-xs transition-all inline-flex items-center gap-1.5 shadow-[0_4px_16px_rgba(252,136,13,0.25)] hover:shadow-[0_6px_24px_rgba(252,136,13,0.35)] hover:-translate-y-0.5 whitespace-nowrap">
                                    Enroll Now <i data-lucide="arrow-right" class="w-3.5 h-3.5"></i>
                                </a>
                            </div>
                        </div>
                ...
                <div class="upcoming-card animate-fade-up" style="animation-delay:0.3s" id="course-lebanese">
                    <div class="flex flex-col md:flex-row">
                        <div class="relative w-full md:w-[38%] h-[220px] md:h-auto overflow-hidden flex-shrink-0">
                            <img src="assets/images/lebanese-cuisine-hero.png" alt="Lebanese Cuisine Part-1" class="w-full h-full object-cover hover:scale-105 transition-transform duration-700" style="min-height:100%">
                            <div class="absolute inset-0 bg-gradient-to-t md:bg-gradient-to-r from-black/30 to-transparent pointer-events-none"></div>
                        ...
                        <div class="flex-1 min-w-0 p-5 md:p-6 flex flex-col justify-between">
                            <div>
                                ...
                                <h3 class="font-bold text-dark text-base md:text-lg mb-2 leading-snug">Online Lebanese Cuisine Part-1</h3>
                                <p class="text-gray-400 text-[12px] leading-relaxed mb-3">19+ recipes — Falafel, Hummus, Manakeesh, Pita Bread, Basbousa & more. Mediterranean flavors from home!</p>
                                ...
                                <div class="grid grid-cols-2 gap-1.5 mb-3">
                                    ...
                                    <div class="flex items-center gap-1.5 text-[11px] text-gray-500 bg-[#FFF8F0] px-2.5 py-2 rounded-lg">
                                        <i data-lucide="monitor-play" class="w-3 h-3 text-mustard flex-shrink-0"></i>
                                        <span>Live on Facebook</span>
                                    </div>
                                    <div class="flex items-center gap-1.5 text-[11px] text-gray-500 bg-[#FFF8F0] px-2.5 py-2 rounded-lg">
                                        <i data-lucide="tag" class="w-3 h-3 text-mustard flex-shrink-0"></i>
                            ...
                            <div class="flex flex-wrap items-center gap-3 pt-3 border-t border-gray-100">
                                ...
                                <a href="/courses/lebanese-1" class="ml-auto bg-mustard hover:bg-mustard-dark text-white font-semibold px-4 py-2 rounded-xl text-xs transition-all inline-flex items-center gap-1.5 shadow-[0_4px_16px_rgba(252,136,13,0.25)] hover:shadow-[0_6px_24px_rgba(252,136,13,0.35)] hover:-translate-y-0.5 whitespace-nowrap">
                                    Enroll Now <i data-lucide="arrow-right" class="w-3.5 h-3.5"></i>
                                </a>
                            </div>
                        </div>
                ...
                <div class="upcoming-card animate-fade-up" style="animation-delay:0.4s" id="course-delhi-chaat">
                    <div class="flex flex-col md:flex-row">
                        <div class="relative w-full md:w-[38%] h-[220px] md:h-auto overflow-hidden flex-shrink-0">
                            <img src="assets/images/161.jpeg" alt="Authentic Delhi Chaat" class="w-full h-full object-cover hover:scale-105 transition-transform duration-700" style="min-height:100%">
                            <div class="absolute inset-0 bg-gradient-to-t md:bg-gradient-to-r from-black/30 to-transparent pointer-events-none"></div>
                        ...
                        <div class="flex-1 min-w-0 p-5 md:p-6 flex flex-col justify-between">
                            <div>
                                ...
                                <h3 class="font-bold text-dark text-base md:text-lg mb-2 leading-snug">Authentic Delhi Chaat</h3>
                                <p class="text-gray-400 text-[12px] leading-relaxed mb-3">30+ recipes — Samosa, Gol Gappa, Pav Bhaji, Chole Bhature, Dabeli, Raj Kachori & much more!</p>
                            ...
                            <div class="flex flex-wrap items-center gap-3 pt-3 border-t border-gray-100">
                                ...
                                <a href="/courses/delhi-chaat" class="ml-auto bg-mustard hover:bg-mustard-dark text-white font-semibold px-4 py-2 rounded-xl text-xs transition-all inline-flex items-center gap-1.5 shadow-[0_4px_16px_rgba(252,136,13,0.25)] hover:shadow-[0_6px_24px_rgba(252,136,13,0.35)] hover:-translate-y-0.5 whitespace-nowrap">
                                    Enroll Now <i data-lucide="arrow-right" class="w-3.5 h-3.5"></i>
                                </a>
                            </div>
                        </div>
