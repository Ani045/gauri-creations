...
<head>
    <title>Lebanese Cuisine Part-1 | Gauri Creations</title>
    ...
    <section class="py-6 md:py-12">
        <div class="max-w-[1200px] mx-auto px-5 md:px-10">
            ...
            <div class="flex items-center gap-2 text-xs text-gray-400 mb-5">
                ...
                <span class="text-dark">Lebanese Cuisine Part-1</span>
            </div>
                ...
                <div class="flex flex-col-reverse sm:flex-row gap-3">
                    ...
                    <div class="flex sm:flex-col gap-2 sm:w-[72px] shrink-0">
                        <div class="thumb active rounded-lg overflow-hidden aspect-square border-2 border-[#fc880d] opacity-100"
                            ...
                            <img src="/assets/images/lebanese-cuisine-hero.png" alt="Lebanese Mezze Platter" class="w-full h-full object-cover">
                        </div>
                        <div class="thumb rounded-lg overflow-hidden aspect-square border-2 border-transparent opacity-60"
                            onclick="switchImg(this, '/assets/images/lebanese-falafel.png')">
                            <img src="/assets/images/lebanese-falafel.png" alt="Falafel" class="w-full h-full object-cover">
                        </div>
                        <div class="thumb rounded-lg overflow-hidden aspect-square border-2 border-transparent opacity-60"
                            onclick="switchImg(this, '/assets/images/lebanese-manakeesh.png')">
                            <img src="/assets/images/lebanese-manakeesh.png" alt="Manakeesh" class="w-full h-full object-cover">
                        </div>
                        <div class="thumb rounded-lg overflow-hidden aspect-square border-2 border-transparent opacity-60"
                        ...
                        <div class="thumb rounded-lg overflow-hidden aspect-square border-2 border-transparent opacity-60"
                            onclick="switchImg(this, '/assets/images/lebanese-basbousa.png')">
                            <img src="/assets/images/lebanese-basbousa.png" alt="Basbousa" class="w-full h-full object-cover">
                        </div>
                    </div>
                    <!-- Main image -->
                    <div class="flex-1 rounded-2xl overflow-hidden bg-[#FAF7F2] aspect-[3/4] sm:aspect-[4/5]">
                        <img id="mainImg" src="/assets/images/lebanese-cuisine-hero.png" alt="Lebanese Cuisine Part-1"
                ...
                <div class="lg:sticky lg:top-[80px]">
                    ...
                    <div class="flex items-center gap-2 mb-4">
                        ...
                        <span
                            ...
                            Vegetarian</span>
                        <span
                            class="bg-[#2563eb]/10 text-[#2563eb] text-[10px] font-bold uppercase px-3 py-1 rounded-full">Online</span>
                    </div>

                    <!-- Title -->
                    <h1 class="font-serif text-[26px] md:text-[32px] font-bold text-dark leading-tight mb-2">🇱🇧
                        Online Lebanese Cuisine Part-1</h1>
                    <p class="text-muted text-[14px] leading-relaxed mb-5">An assorted platter of snacks, dips, salads and breads, the main-stay of Lebanese cuisine. What better opportunity for a relaxing meal with friends.</p>
                    <p class="text-muted text-[13px] leading-relaxed mb-5">Healthy and rich in protein • 100% vegetarian</p>
                    ...
                    <div class="grid grid-cols-2 gap-3 mb-5">
                        <div
                            ...
                            <div>
                                ...
                                <p class="text-sm text-dark font-bold">11 AM – 5 PM</p>
                            </div>
                        </div>
                        <div
                            class="flex items-center gap-2.5 bg-[#FAF7F2] rounded-xl px-3.5 py-2.5 border border-[#EDE4D8]">
                    ...
                    <div class="grid grid-cols-2 gap-3 mb-5">
                        <div
                            ...
                            <div>
                                ...
                                <p class="text-sm text-dark font-bold">21st JAN Sunday</p>
                            </div>
                        </div>
                        <div
                            class="flex items-center gap-2.5 bg-[#FAF7F2] rounded-xl px-3.5 py-2.5 border border-[#EDE4D8]">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-dark font-bold">Rs 4500</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-x-4 gap-y-2 mb-6 text-[13px]">
                        <span class="flex items-center gap-2 text-muted"><i data-lucide="check"
                                class="w-3.5 h-3.5 text-[#16a34a] shrink-0"></i> Printed Recipe Provided</span>
                        <span class="flex items-center gap-2 text-muted"><i data-lucide="check"
                                class="w-3.5 h-3.5 text-[#16a34a] shrink-0"></i> Refreshment & Lunch</span>
                        <span class="flex items-center gap-2 text-muted"><i data-lucide="check"
                                class="w-3.5 h-3.5 text-[#16a34a] shrink-0"></i> Hands-On Practical</span>
                        <span class="flex items-center gap-2 text-muted"><i data-lucide="check"
                                class="w-3.5 h-3.5 text-[#16a34a] shrink-0"></i> Future Assistance Welcome</span>
                    </div>
                    ...
                    <div class="mt-4 flex items-center gap-3">
                        <a href="https://www.instagram.com/gauricreations_/?hl=en" target="_blank" class="inline-flex items-center gap-2 text-xs text-muted hover:text-[#fc880d] transition-colors">
    ...
    <section class="py-10 md:py-12 bg-[#FAF7F2] border-t border-[#EDE4D8]">
        <div class="max-w-[1200px] mx-auto px-5 md:px-10">
            <div class="flex items-center justify-between mb-5">
                ...
                <span class="text-[#fc880d] text-xs font-bold bg-[#fc880d]/10 px-3 py-1 rounded-full">19+ Recipes</span>
            </div>

            <!-- Breads & Flatbreads -->
            <p class="text-sm font-bold text-dark mb-3 mt-6 flex items-center gap-2">🫓 Breads & Flatbreads</p>
            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-2 mb-6">
                ...
                <div class="ci bg-[#fc880d]/5 px-3 py-2.5 rounded-lg border border-[#fc880d]/20 text-[12px] font-bold text-[#fc880d]">Pita Sticks</div>
                <div class="ci bg-[#fc880d]/5 px-3 py-2.5 rounded-lg border border-[#fc880d]/20 text-[12px] font-bold text-[#fc880d]">Manakeesh</div>
                <div class="ci bg-[#fc880d]/5 px-3 py-2.5 rounded-lg border border-[#fc880d]/20 text-[12px] font-bold text-[#fc880d]">Za'atar & Cheese Manakeesh</div>
                <div class="ci bg-[#fc880d]/5 px-3 py-2.5 rounded-lg border border-[#fc880d]/20 text-[12px] font-bold text-[#fc880d]">Tomato & Cheese Manakeesh</div>
                <div class="ci bg-[#fc880d]/5 px-3 py-2.5 rounded-lg border border-[#fc880d]/20 text-[12px] font-bold text-[#fc880d]">Manakeesh Sticks</div>
                <div class="ci bg-[#fc880d]/5 px-3 py-2.5 rounded-lg border border-[#fc880d]/20 text-[12px] font-bold text-[#fc880d]">Lavash</div>
                <div class="ci bg-[#fc880d]/5 px-3 py-2.5 rounded-lg border border-[#fc880d]/20 text-[12px] font-bold text-[#fc880d]">Pita Pockets</div>
            </div>

            <!-- Dips & Spreads -->
            <p class="text-sm font-bold text-dark mb-3 flex items-center gap-2">🥣 Dips & Spreads</p>
            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-2 mb-6">
                <div class="ci bg-white px-3 py-2.5 rounded-lg border border-[#EDE4D8] text-[12px] font-medium text-dark">Tahini</div>
                <div class="ci bg-white px-3 py-2.5 rounded-lg border border-[#EDE4D8] text-[12px] font-medium text-dark">Hummus</div>
                <div class="ci bg-white px-3 py-2.5 rounded-lg border border-[#EDE4D8] text-[12px] font-medium text-dark">Labneh</div>
            </div>

            <!-- Spice Powders -->
            <p class="text-sm font-bold text-dark mb-3 flex items-center gap-2">🌶️ Spice Powders</p>
            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-2 mb-6">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-2 mb-6">
                <div class="ci bg-[#fc880d]/5 px-3 py-2.5 rounded-lg border border-[#fc880d]/20 text-[12px] font-bold text-[#fc880d]">Falafel</div>
                <div class="ci bg-[#fc880d]/5 px-3 py-2.5 rounded-lg border border-[#fc880d]/20 text-[12px] font-bold text-[#fc880d]">Stuffed Spinach 'N' Cheese Potatoes</div>
                ...
                <div class="ci bg-[#fc880d]/5 px-3 py-2.5 rounded-lg border border-[#fc880d]/20 text-[12px] font-bold text-[#fc880d]">Veg Cheese Sambousik</div>
            </div>
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-2 mb-4">
                <div class="ci bg-white px-3 py-2.5 rounded-lg border border-[#EDE4D8] text-[12px] font-medium text-dark">Aish El Saraya</div>
                <div class="ci bg-white px-3 py-2.5 rounded-lg border border-[#EDE4D8] text-[12px] font-medium text-dark">Basbousa</div>
            </div>
    ...
    <section class="py-10 md:py-12 bg-white border-t border-gray-100">
        <div class="max-w-[1200px] mx-auto px-5 md:px-10">
            ...
            <div class="grid sm:grid-cols-3 gap-5">
                <a href="/courses/lebanese-2" class="group block">
                    <div class="rounded-2xl overflow-hidden aspect-[4/3] bg-[#FAF7F2] mb-3 relative">
                        <img src="/assets/images/lebanese-shawarma.png" alt="Lebanese Cuisine Part-2"
                    ...
                    <h3
                        ...
                        Lebanese Cuisine Part-2</h3>
                    <p class="text-gray-400 text-xs mt-1">18 Recipes — Shawarma, Fattoush, Kunafa & More</p>
                </a>
