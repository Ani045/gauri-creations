            ...
            <div class="grid lg:grid-cols-2 gap-8 lg:gap-12 items-start">
                ...
                <div class="flex flex-col-reverse sm:flex-row gap-3">
                    <div class="flex sm:flex-col gap-2 sm:w-[72px] shrink-0">
                        <div class="thumb active rounded-lg overflow-hidden aspect-square border-2 border-[#fc880d] opacity-100"
                            ...
                            <img src="/assets/images/puff_pastry_main_1776170197994.png" alt="Puff Pastries Class" class="w-full h-full object-cover">
                        </div>
                        ...
                        <div class="thumb rounded-lg overflow-hidden aspect-square border-2 border-transparent opacity-60"
                            onclick="switchImg(this, '/assets/images/345.jpeg')">
                            <img src="/assets/images/345.jpeg" alt="" class="w-full h-full object-cover">
                        </div>
                    </div>
                    <div class="flex-1 rounded-2xl overflow-hidden bg-[#FAF7F2] aspect-[3/4] sm:aspect-[4/5]">
                        <img id="mainImg" src="/assets/images/puff_pastry_main_1776170197994.png" alt="Puff Pastries & Cream Horn Class"
                ...
                <div class="lg:sticky lg:top-[80px]">
                    ...
                    <div class="flex items-center gap-2 mb-4">
                        <span class="bg-[#9333ea] text-white text-[10px] font-bold uppercase px-3 py-1 rounded-full">New Class</span>
                        <span class="bg-[#16a34a]/10 text-[#16a34a] text-[10px] font-bold uppercase px-3 py-1 rounded-full">100% Vegetarian</span>
                    </div>

                    <!-- Title -->
                    <h1 class="font-serif text-[26px] md:text-[32px] font-bold text-dark leading-tight mb-2">Exotic Puff Pastry & Cream Horn Masterclass</h1>
                    <p class="text-muted text-[14px] leading-relaxed mb-5">🥐✨ Master the Art of Flaky, Buttery & Irresistible Puff Pastries! Layers of crisp perfection, melt-in-mouth texture, and bakery-style elegance — learn to create stunning sweet & savoury delights professionally. From golden khari to chocolate croissants, this class is a dream for every baking foodie!</p>
                    ...
                    <div class="flex items-center gap-3 mb-5">
                        <span class="bg-[#fc880d]/10 text-[#fc880d] text-xs font-bold px-3 py-1.5 rounded-full">Bakery Techniques</span>
                        <span class="bg-[#9333ea]/10 text-[#9333ea] text-xs font-bold px-3 py-1.5 rounded-full">Beginner Friendly</span>
                    </div>

                    <div class="mb-5 pb-5 border-b border-gray-100"></div>

                    <!-- What's Included -->
                    <p class="text-xs font-bold uppercase tracking-wider text-gray-400 mb-3">What Makes This Class Special?</p>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-4 gap-y-2 mb-6 text-[13px]">
                        ...
                        <span class="flex items-center gap-2 text-muted"><i data-lucide="check" class="w-3.5 h-3.5 text-[#16a34a] shrink-0"></i> Samples + Box Provided</span>
                    </div>
    ...
    <section class="py-10 md:py-12 bg-[#FAF7F2] border-t border-[#EDE4D8]">
        <div class="max-w-[1200px] mx-auto px-5 md:px-10">
            <div class="flex items-center justify-between mb-6">
                ...
                <span class="text-[#fc880d] text-xs font-bold bg-[#fc880d]/10 px-3 py-1 rounded-full">Premium Creations</span>
            </div>
        ...
        <div class="max-w-[1200px] mx-auto px-5 md:px-10">
            ...
            <div class="grid sm:grid-cols-3 gap-5">
                ...
                <a href="/courses/cookies-biscuits" class="group block">
                    <div class="rounded-2xl overflow-hidden aspect-[4/3] bg-[#FAF7F2] mb-3 relative">
                        <img src="/assets/images/111.jpeg" alt="Cookies and Biscuits" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-transparent"></div>
                        <span class="absolute bottom-3 left-3 bg-white/90 backdrop-blur-sm text-dark text-[10px] font-bold uppercase px-2.5 py-1 rounded-full">Cookies</span>
                    </div>
                    <h3 class="font-bold text-dark text-[15px] leading-snug group-hover:text-[#fc880d] transition-colors">Bakery Style Cookies</h3>
                    <p class="text-gray-400 text-xs mt-1">33 Varieties of Cookies & Biscuits</p>
                </a>
                <a href="/courses/italian" class="group block">
                    <div class="rounded-2xl overflow-hidden aspect-[4/3] bg-[#FAF7F2] mb-3 relative">
                        <img src="/assets/images/321.jpeg" alt="Italian Food Class" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-transparent"></div>
                    ...
                    <h3 class="font-bold text-dark text-[15px] leading-snug group-hover:text-[#fc880d] transition-colors">Italian Masterclass</h3>
