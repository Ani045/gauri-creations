            ...
            <div class="grid lg:grid-cols-2 gap-8 lg:gap-12 items-start">
                ...
                <div class="flex flex-col-reverse sm:flex-row gap-3">
                    <div class="flex sm:flex-col gap-2 sm:w-[72px] shrink-0">
                        ...
                        <div class="thumb rounded-lg overflow-hidden aspect-square border-2 border-transparent opacity-60"
                            onclick="switchImg(this, '/assets/images/veg_snacks_3_1776084468572.png')">
                            <img src="/assets/images/veg_snacks_3_1776084468572.png" alt="" class="w-full h-full object-cover">
                        </div>
                        <div class="thumb rounded-lg overflow-hidden aspect-square border-2 border-transparent opacity-60"
                            onclick="switchImg(this, '/assets/images/veg_snacks_4_1776084419525.png')">
                            <img src="/assets/images/veg_snacks_4_1776084419525.png" alt="" class="w-full h-full object-cover">
                        </div>
                    </div>
