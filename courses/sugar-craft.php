...
<head>
    <title>Sugar Craft Cake Decorating Course | Gauri Creations</title>
...
<body class="font-sans bg-light text-dark antialiased overflow-x-hidden transition-all duration-300">
    ...
    <div class="bg-gray-50 border-b border-gray-100 py-3">
        <div class="max-w-[1300px] mx-auto px-6 md:px-12 flex items-center gap-2 text-sm">
            ...
            <span class="text-gray-300">/</span>
            <span class="text-dark font-medium">Sugar Craft Cake Decorating Course</span>
        </div>
    </div>
            ...
            <div class="grid lg:grid-cols-[1fr_420px] gap-10 lg:gap-12 items-start">
                ...
                <div class="flex flex-col gap-5">
                    <div class="rounded-[2rem] overflow-hidden shadow-xl relative aspect-[16/10] bg-[#FFF8F0] group border border-[#EDE4D8]">
                        <img src="/assets/images/caterpillar-cupcakes.jpeg" alt="Sugar Craft Cake Decorating Course" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700">
                    ...
                    <div class="bg-[#FAF7F2] rounded-2xl p-6 border border-[#EDE4D8]">
                        ...
                        <p class="text-muted text-[15px] leading-relaxed">This TWO DAYS Sugar Craft Cake Decorating course will teach you all of the techniques to decorate cakes that would be amazing! Learn how to cover a cake with Ganache, Sugar paste, and make incredible decorations.</p>
                    </div>

                    <!-- Highlights -->
                    <ul class="flex flex-col gap-3">
                        <li class="flex items-start gap-3"><div class="w-6 h-6 rounded-full bg-[#fc880d]/10 flex items-center justify-center shrink-0 mt-0.5"><i data-lucide="check" class="w-3.5 h-3.5 text-[#fc880d]"></i></div><span>Fully Hands-On Class</span></li>
                        ...
                        <li class="flex items-start gap-3"><div class="w-6 h-6 rounded-full bg-[#fc880d]/10 flex items-center justify-center shrink-0 mt-0.5"><i data-lucide="check" class="w-3.5 h-3.5 text-[#fc880d]"></i></div><span>Includes Cake Covered with Ganache</span></li>
                ...
                <div class="lg:sticky lg:top-[90px] flex flex-col gap-4">
                    <div class="bg-dark rounded-[1.5rem] p-6 text-white relative overflow-hidden">
                        ...
                        <div class="relative z-10">
                            ...
                            <h1 class="text-xl md:text-2xl font-serif text-white font-bold leading-snug mb-5">Sugar Craft Cake Decorating Course</h1>
                            <div class="flex flex-col gap-3 mb-5">
                                <div class="flex items-center gap-3 bg-white/5 rounded-xl px-4 py-3 border border-white/10">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-white font-bold">8th & 9th April</p>
                                        <p class="text-[11px] text-white/50">(Tuesday & Wednesday)</p>
                                    </div>
                                </div>
    ...
    <section class="py-16 bg-[#FAF7F2]">
        <div class="max-w-[1300px] mx-auto px-6 md:px-12">
            ...
            <div class="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
                <div class="flex items-center gap-3 bg-[#FFF8F0] px-4 py-3 rounded-xl border border-[#fc880d]/10"><i data-lucide="chef-hat" class="w-4 h-4 text-[#fc880d] shrink-0"></i><span class="text-dark text-sm font-medium">How to Make Fondant Dough From Scratch</span></div>
                <div class="flex items-center gap-3 bg-[#FFF8F0] px-4 py-3 rounded-xl border border-[#fc880d]/10"><i data-lucide="chef-hat" class="w-4 h-4 text-[#fc880d] shrink-0"></i><span class="text-dark text-sm font-medium">Covering Cake with Ganache</span></div>
                <div class="flex items-center gap-3 bg-[#FFF8F0] px-4 py-3 rounded-xl border border-[#fc880d]/10"><i data-lucide="chef-hat" class="w-4 h-4 text-[#fc880d] shrink-0"></i><span class="text-dark text-sm font-medium">Covering Cake with Sugar Paste</span></div>
                <div class="flex items-center gap-3 bg-[#FFF8F0] px-4 py-3 rounded-xl border border-[#fc880d]/10"><i data-lucide="chef-hat" class="w-4 h-4 text-[#fc880d] shrink-0"></i><span class="text-dark text-sm font-medium">Ruffles</span></div>
                <div class="flex items-center gap-3 bg-[#FFF8F0] px-4 py-3 rounded-xl border border-[#fc880d]/10"><i data-lucide="chef-hat" class="w-4 h-4 text-[#fc880d] shrink-0"></i><span class="text-dark text-sm font-medium">Rose Making</span></div>
                <div class="flex items-center gap-3 bg-[#FFF8F0] px-4 py-3 rounded-xl border border-[#fc880d]/10"><i data-lucide="chef-hat" class="w-4 h-4 text-[#fc880d] shrink-0"></i><span class="text-dark text-sm font-medium">Flower Making</span></div>
                <div class="flex items-center gap-3 bg-[#FFF8F0] px-4 py-3 rounded-xl border border-[#fc880d]/10"><i data-lucide="chef-hat" class="w-4 h-4 text-[#fc880d] shrink-0"></i><span class="text-dark text-sm font-medium">Leaves Making</span></div>
                <div class="flex items-center gap-3 bg-[#FFF8F0] px-4 py-3 rounded-xl border border-[#fc880d]/10"><i data-lucide="chef-hat" class="w-4 h-4 text-[#fc880d] shrink-0"></i><span class="text-dark text-sm font-medium">Animal Figure Making</span></div>
                <div class="flex items-center gap-3 bg-[#FFF8F0] px-4 py-3 rounded-xl border border-[#fc880d]/10"><i data-lucide="chef-hat" class="w-4 h-4 text-[#fc880d] shrink-0"></i><span class="text-dark text-sm font-medium">Cartoon Character Figure Making</span></div>
                <div class="flex items-center gap-3 bg-[#FFF8F0] px-4 py-3 rounded-xl border border-[#fc880d]/10"><i data-lucide="chef-hat" class="w-4 h-4 text-[#fc880d] shrink-0"></i><span class="text-dark text-sm font-medium">Sugar Craft Baby Shower and Birthday Theme Cake</span></div>
                <div class="flex items-center gap-3 bg-[#FFF8F0] px-4 py-3 rounded-xl border border-[#fc880d]/10"><i data-lucide="chef-hat" class="w-4 h-4 text-[#fc880d] shrink-0"></i><span class="text-dark text-sm font-medium">Rainbow Cake</span></div>
                <div class="flex items-center gap-3 bg-[#FFF8F0] px-4 py-3 rounded-xl border border-[#fc880d]/10"><i data-lucide="chef-hat" class="w-4 h-4 text-[#fc880d] shrink-0"></i><span class="text-dark text-sm font-medium">Use of Sugar Craft Tools</span></div>
                <div class="flex items-center gap-3 bg-[#FFF8F0] px-4 py-3 rounded-xl border border-[#fc880d]/10"><i data-lucide="chef-hat" class="w-4 h-4 text-[#fc880d] shrink-0"></i><span class="text-dark text-sm font-medium">Message Plaque Making</span></div>
            </div>
