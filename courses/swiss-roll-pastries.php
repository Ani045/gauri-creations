    ...
    <section class="py-10 md:py-12 bg-white border-t border-gray-100">
        <div class="max-w-[1200px] mx-auto px-5 md:px-10">
            ...
            <div class="grid sm:grid-cols-3 gap-5">
                ...
                <a href="/courses/cheesecakes" class="group block">
                    <div class="rounded-2xl overflow-hidden aspect-[4/3] bg-[#FAF7F2] mb-3 relative">
                        ...
                        <div class="absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-transparent"></div>
                        <span class="absolute bottom-3 left-3 bg-white/90 backdrop-blur-sm text-dark text-[10px] font-bold uppercase px-2.5 py-1 rounded-full">Cheesecakes</span>
                    </div>
                    <h3 class="font-bold text-dark text-[15px] leading-snug group-hover:text-[#fc880d] transition-colors">Eggless Gelatin Free Baked & Non-Baked Cheesecakes</h3>
                    <p class="text-gray-400 text-xs mt-1">21 Flavours — Baked & No-Bake</p>
                </a>
            </div>
        </div>
    </section>
