...
<head>
    <title>Mexican Cuisine Class | Gauri Creations</title>
    ...
    <section class="py-6 md:py-12">
        <div class="max-w-[1200px] mx-auto px-5 md:px-10">
            ...
            <div class="flex items-center gap-2 text-xs text-gray-400 mb-5">
                ...
                <span class="text-dark">Mexican Cuisine</span>
            </div>
            ...
            <div class="grid lg:grid-cols-2 gap-8 lg:gap-12 items-start">
                ...
                <div class="flex flex-col-reverse sm:flex-row gap-3">
                    ...
                    <div class="flex sm:flex-col gap-2 sm:w-[72px] shrink-0">
                        ...
                        <div class="thumb rounded-lg overflow-hidden aspect-square border-2 border-transparent opacity-60"
                            ...
                            <img src="/assets/images/144.jpeg" alt="" class="w-full h-full object-cover">
                        </div>
                        <div class="thumb rounded-lg overflow-hidden aspect-square border-2 border-transparent opacity-60"
                            onclick="switchImg(this, '/assets/images/145.jpeg')">
                            <img src="/assets/images/145.jpeg" alt="" class="w-full h-full object-cover">
                        </div>
                        <div class="thumb rounded-lg overflow-hidden aspect-square border-2 border-transparent opacity-60"
                            onclick="switchImg(this, '/assets/images/146.jpeg')">
                            <img src="/assets/images/146.jpeg" alt="" class="w-full h-full object-cover">
                        </div>
                    </div>
                    <!-- Main image -->
                ...
                <div class="lg:sticky lg:top-[80px]">
                    ...
                    <h1 class="font-serif text-[26px] md:text-[32px] font-bold text-dark leading-tight mb-2">🌶️
                        Authentic & Exotic Mexican Cuisines 🇲🇽</h1>
                    <p class="text-muted text-[14px] leading-relaxed mb-5">Dive into the world of bold flavors, vibrant
                        colors, and irresistible aromas! From crispy tacos to cheesy enchiladas — learn everything
                        homemade, healthy, and absolutely delicious.</p>
                    ...
                    <div class="flex items-center gap-3 mb-5">
                        <span class="bg-[#fc880d]/10 text-[#fc880d] text-xs font-bold px-3 py-1.5 rounded-full">20
                            Practicals</span>
                        <span class="bg-[#fc880d]/10 text-[#fc880d] text-xs font-bold px-3 py-1.5 rounded-full">35
                            Recipes</span>
                    </div>
    ...
    <section class="py-10 md:py-12 bg-[#FAF7F2] border-t border-[#EDE4D8]">
        <div class="max-w-[1200px] mx-auto px-5 md:px-10">
            <div class="flex items-center justify-between mb-5">
                ...
                <span class="text-[#fc880d] text-xs font-bold bg-[#fc880d]/10 px-3 py-1 rounded-full">20 Practicals | 35
                    Recipes</span>
            </div>

            <!-- Soups -->
            <p class="text-sm font-bold text-dark mb-3 mt-6 flex items-center gap-2">🌮 Soups</p>
            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-2 mb-6">
                <div
                    class="ci bg-white px-3 py-2.5 rounded-lg border border-[#EDE4D8] text-[12px] font-medium text-dark">
                    Chilly Bean Soup</div>
                <div
                    class="ci bg-white px-3 py-2.5 rounded-lg border border-[#EDE4D8] text-[12px] font-medium text-dark">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-2 mb-6">
                <div
                    class="ci bg-white px-3 py-2.5 rounded-lg border border-[#EDE4D8] text-[12px] font-medium text-dark">
                    Nachos with Cheese Sauce</div>
                <div
                    class="ci bg-white px-3 py-2.5 rounded-lg border border-[#EDE4D8] text-[12px] font-medium text-dark">
                    Tacos with Crunchy Bean Masala</div>
                <div
                    class="ci bg-white px-3 py-2.5 rounded-lg border border-[#EDE4D8] text-[12px] font-medium text-dark">
                    Burritos Platter</div>
                <div
                    class="ci bg-white px-3 py-2.5 rounded-lg border border-[#EDE4D8] text-[12px] font-medium text-dark">
                    Vegetable Mexican Fajitas Platter</div>
                <div
                    class="ci bg-white px-3 py-2.5 rounded-lg border border-[#EDE4D8] text-[12px] font-medium text-dark">
                    Quesadillas with Fresh Salsa 🧀</div>
                <div
                    class="ci bg-white px-3 py-2.5 rounded-lg border border-[#EDE4D8] text-[12px] font-medium text-dark">
                    Mexican Creyol Paneer Shklet</div>
                <div
                    class="ci bg-white px-3 py-2.5 rounded-lg border border-[#EDE4D8] text-[12px] font-medium text-dark">
                    Mexican Stuffed Capsicum</div>
                <div
                    class="ci bg-white px-3 py-2.5 rounded-lg border border-[#EDE4D8] text-[12px] font-medium text-dark">
                    Mexican Trio Platter</div>
                <div
                    class="ci bg-white px-3 py-2.5 rounded-lg border border-[#EDE4D8] text-[12px] font-medium text-dark">
                    Pineapple Salsa</div>
                <div
                    class="ci bg-white px-3 py-2.5 rounded-lg border border-[#EDE4D8] text-[12px] font-medium text-dark">
                    Spinach Corn Quineis</div>
                <div
                    class="ci bg-white px-3 py-2.5 rounded-lg border border-[#EDE4D8] text-[12px] font-medium text-dark">
                    Mexican Red Rice</div>
                <div
                    class="ci bg-white px-3 py-2.5 rounded-lg border border-[#EDE4D8] text-[12px] font-medium text-dark">
                    Onion Rings</div>
                <div
            ...
            <!-- Baked Dishes -->
            <p class="text-sm font-bold text-dark mb-3 flex items-center gap-2">🥘 Baked Dishes</p>
            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-2 mb-6">
                <div
                    class="ci bg-[#fc880d]/5 px-3 py-2.5 rounded-lg border border-[#fc880d]/20 text-[12px] font-bold text-[#fc880d]">
                    Spinach Corn Mexican Tart</div>
                <div
                    class="ci bg-[#fc880d]/5 px-3 py-2.5 rounded-lg border border-[#fc880d]/20 text-[12px] font-bold text-[#fc880d]">
                    Two-Corn Enchiladas</div>
                <div
                    class="ci bg-[#fc880d]/5 px-3 py-2.5 rounded-lg border border-[#fc880d]/20 text-[12px] font-bold text-[#fc880d]">
                    Mexican Trio</div>
                <div
                    class="ci bg-[#fc880d]/5 px-3 py-2.5 rounded-lg border border-[#fc880d]/20 text-[12px] font-bold text-[#fc880d]">
                    Stuffed Bell Peppers with Mexican Rice</div>
            </div>

            <!-- Sauces & Dips -->
            <p class="text-sm font-bold text-dark mb-3 flex items-center gap-2">🥣 Sauces & Dips</p>
            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-2 mb-6">
                <div
                    class="ci bg-white px-3 py-2.5 rounded-lg border border-[#EDE4D8] text-[12px] font-medium text-dark">
                    Mexican Sauce</div>
            ...
            <!-- More -->
            <p class="text-sm font-bold text-dark mb-3 flex items-center gap-2">🍚 More</p>
            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-2 mb-4">
                ...
                <div
                    class="ci bg-[#fc880d]/5 px-3 py-2.5 rounded-lg border border-[#fc880d]/20 text-[12px] font-bold text-[#fc880d]">
                    Flour Dough for Tortilla</div>
                <div
                    class="ci bg-[#fc880d]/5 px-3 py-2.5 rounded-lg border border-[#fc880d]/20 text-[12px] font-bold text-[#fc880d]">
                    Corn Dough for Tortilla, Nachos & Tacos</div>
                <div
                    class="ci bg-[#fc880d]/5 px-3 py-2.5 rounded-lg border border-[#fc880d]/20 text-[12px] font-bold text-[#fc880d]">
                    Mediterranean Salad</div>
                <div
                    class="ci bg-[#fc880d]/5 px-3 py-2.5 rounded-lg border border-[#fc880d]/20 text-[12px] font-bold text-[#fc880d]">
                    Homemade Taco Shells & Nachos</div>
                <div
                    class="ci bg-[#fc880d]/5 px-3 py-2.5 rounded-lg border border-[#fc880d]/20 text-[12px] font-bold text-[#fc880d]">
                    Mexican Brinjals</div>
            </div>
            <p class="text-[#fc880d] font-bold text-sm mt-2">🎉 And Lots More…</p>
        </div>
    </section>
            ...
            <div class="grid sm:grid-cols-3 gap-5">
                <a href="/courses/chinese" class="group block">
                    <div class="rounded-2xl overflow-hidden aspect-[4/3] bg-[#FAF7F2] mb-3 relative">
                        <img src="/assets/images/131.jpeg" alt="Chinese Cooking Class"
                            class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-transparent">
                        </div>
                        <span
                            class="absolute bottom-3 left-3 bg-white/90 backdrop-blur-sm text-dark text-[10px] font-bold uppercase px-2.5 py-1 rounded-full">Chinese
                            Cooking</span>
                    </div>
                    <h3
                        class="font-bold text-dark text-[15px] leading-snug group-hover:text-[#fc880d] transition-colors">
                        Chinese Cooking Class</h3>
                    <p class="text-gray-400 text-xs mt-1">20+ Recipes — Momos, Manchurian, Noodles & More</p>
                </a>
                <a href="/courses/italian" class="group block">
                    <div class="rounded-2xl overflow-hidden aspect-[4/3] bg-[#FAF7F2] mb-3 relative">
                        <img src="/assets/images/pad-thai-dish.jpeg" alt="Italian Food Class"
                            class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-transparent">
                        </div>
                        <span
                    ...
                    <h3
                        class="font-bold text-dark text-[15px] leading-snug group-hover:text-[#fc880d] transition-colors">
                        Italian Food Class</h3>
                    <p class="text-gray-400 text-xs mt-1">20+ Recipes — Pizza, Pasta, Risotto & More</p>
                </a>
                <a href="/courses/mughlai" class="group block">
                    <div class="rounded-2xl overflow-hidden aspect-[4/3] bg-[#FAF7F2] mb-3 relative">
                        <img src="/assets/images/81.jpeg" alt="Veg Mughlai Food Class"
                            class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-transparent">
                        </div>
                        <span
                            class="absolute bottom-3 left-3 bg-white/90 backdrop-blur-sm text-dark text-[10px] font-bold uppercase px-2.5 py-1 rounded-full">Mughlai
                            Cuisine</span>
                    </div>
                    <h3
                        class="font-bold text-dark text-[15px] leading-snug group-hover:text-[#fc880d] transition-colors">
                        Mughlai Food Class</h3>
